...
import com.ezlo.automation.framework.common_baby.MyTestListener;
...
public class BaseTest {
    ...
    public void logTestStart(Method method, Object[] p, ITestContext context) {
        app.base().startApp();
    ...
    public void logTestStopWOUI(Method method) {
        app.base().stopApp();
