...
@Entity(value = "FWUC_templates_android", noClassnameStored = true)
public class FWUC_TemplateAndroidData {
    @Id
    @Expose
    @Property("_id")
    private ObjectId id;
    ...
    public FWUC_TemplateAndroidData withId(ObjectId id) {
        this.id = id;
        return this;
    }

    public FWUC_TemplateAndroidData withDeviceType(DeviceTypeData deviceTypeData) {
        this.deviceTypeData = deviceTypeData;
        return this;
    }

    public FWUC_TemplateAndroidData withName(String name) {
        this.name = name;
        return this;
    }

    public FWUC_TemplateAndroidData withStyles(List<StyleData> styles) {
        this.styles = styles;
        return this;
    }

    public FWUC_TemplateAndroidData withTemapltes(List<TemplateData> temapltes) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FWUC_TemplateAndroidData)) return false;
        FWUC_TemplateAndroidData that = (FWUC_TemplateAndroidData) o;
