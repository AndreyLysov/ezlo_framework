...
public class DB_RuleData {
    ...
    public DB_RuleData withData(String data){
        this.data = data;
        return this;
    }

    public DB_RuleData withMd5(String md5){
        this.md5 = md5;
        return this;
    }

    public DB_RuleData withName(String name){
        this.name = name;
        return this;
    }

    public DB_RuleData withUncompressedLength(String uncompressedLength){
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DB_RuleData)) return false;
        DB_RuleData that = (DB_RuleData) o;
